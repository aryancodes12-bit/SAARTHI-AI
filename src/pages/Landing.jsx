...
import {
  ...
  HeadphonesIcon, MessageCircle, Clock, Award
} from 'lucide-react'
...
export default function Landing() {
  ...
  const products = [
    ...
    // Motor products (still under Property category)
  ...
  return (
    <div className="min-h-screen bg-white font-inter">
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-600">
            <button onClick={() => navigate('#')} className="hover:text-[#FF6B00] font-medium">
              <a href="#about-us">About Us</a>
            </button>
            <button onClick={scrollToProducts} className="hover:text-[#FF6B00] font-medium flex items-center gap-1">
              Insurance Products
            </button>
            <button onClick={() => navigate('/login')} className="hover:text-[#FF6B00] font-medium">
              Dashboard
            </button>

            <button onClick={() => navigate('#phone-support')} className="hover:text-[#FF6B00] font-medium flex items-center gap-1">
              <a href="#phone-support">Support</a>
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-2 flex items-center gap-2 text-sm">
              <CheckCircle size={16} className="text-green-500" /> AI detects your life events automatically
            </p>
            <p className="text-gray-600 mb-2 flex items-center gap-2 text-sm">
              <CheckCircle size={16} className="text-green-500" /> Personalized recommendations, no spam
            </p>
            <p className="text-gray-600 mb-6 flex items-center gap-2 text-sm">
              <CheckCircle size={16} className="text-green-500" /> DPDP 2023 compliant & Responsible AI
            </p>
          ...
          {/* WhatsApp mockup with hover blur */}
              ...
              <div className="transition-all duration-300 group-hover:blur-sm">
                ...
                <div className="bg-gray-50 p-4 space-y-3 min-h-48">
                  ...
                  <div className="flex justify-end">
                    <div className="bg-[#0B1F4B] text-white rounded-xl rounded-tr-none p-2.5 text-sm">
                      Yes, tell me more!
                    </div>
                  </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[#0B1F4B]/80 backdrop-blur-sm rounded-2xl">
                <div className="text-center p-4">
                  ...
                  <button
                    ...
                    className="bg-[#FF6B00] text-white px-6 py-2 rounded-full font-bold text-sm hover:bg-orange-600 transition shadow-lg"
                  >
                    Sign In / Sign Up
                  </button>
                </div>
      ...
      {/* AI-Matched Insurance Plans - Hover to unlock */}
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <div>
                  ...
                  <p className="text-blue-100 mt-1 max-w-xl">
                    Personalized recommendations based on your life events.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-500 text-sm">To democratize insurance in India through AI, making the right coverage accessible to every life stage.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition text-center">
              <div className="w-16 h-16 bg-[#0B1F4B]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="text-[#FF6B00]" size={32} />
              </div>
              <h3 className="font-bold text-gray-800 mb-2">Our Team</h3>
              <p className="text-gray-500 text-sm">A blend of insurance experts, AI researchers, and customer advocates working towards a common goal.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition text-center">
              <div className="w-16 h-16 bg-[#0B1F4B]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <HeartHandshake className="text-[#FF6B00]" size={32} />
              </div>
              <h3 className="font-bold text-gray-800 mb-2">Our Promise</h3>
              <p className="text-gray-500 text-sm">Responsible AI, complete transparency, and always putting your consent first – DPDP 2023 compliant.</p>
            </div>
          </div>
        </div>
      </section>

      {/* How SaarthiAI Works - Enhanced */}
            ...
            <div className="flex gap-2 flex-wrap">
              {tabs.map(t => (
                <button key={t} onClick={() => setActiveTab(t)}
                  className={`px-4 py-2 rounded-full text-xs font-medium transition border ${activeTab === t
                    ? 'bg-[#0B1F4B] text-white border-[#0B1F4B]'
                    : 'bg-white text-gray-600 border-gray-300 hover:border-[#0B1F4B]'
                    }`}>
                  {t}
                </button>
              ))}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#FF6B00] text-xs flex items-center gap-1">
                    <Star size={12} fill="#FF6B00" /> {p.tag}
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              When you use SaarthiAI, you get more than recommendations. You get an intelligent agent that learns from your life and protects you proactively.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <section id="phone-support">
              <div
                onClick={() => navigate('/support#phone-support')}
                className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group text-center"
              >
                ...
                <a
                  ...
                  className="text-[#FF6B00] font-medium text-sm inline-flex items-center justify-center gap-1 hover:underline"
                >
            ...
            <section id="chat-support">
              <div
                onClick={() => navigate('/support#chat-support')}
                className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group text-center"
              >
                <div className="w-16 h-16 bg-[#0B1F4B]/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <section id="email-support">
              <div
                onClick={() => navigate('/support#email-support')}
                className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group text-center"
              >
                <div className="w-16 h-16 bg-[#0B1F4B]/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                ...
                <a
                  href="mailto:support@saarthiai.in"
                  onClick={(e) => e.stopPropagation()}
                  className="text-[#FF6B00] font-medium text-sm inline-flex items-center justify-center gap-1 hover:underline"
                >
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {[
            ...
            <div key={col.title}>
              ...
              {col.links.map(l => (
                <a key={l} href="#" className="block text-gray-400 text-xs hover:text-[#FF6B00] mb-2 transition">{l}</a>
              ))}
            </div>
          ))}
          <div>
